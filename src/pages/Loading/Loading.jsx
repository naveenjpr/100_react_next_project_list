    ...
    <>
      ...
      <div className="max-h-screen overflow-auto">
        ...
        <div className="grid grid-cols-3 gap-2 justify-between">
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          ...
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>Ovel shaped loading spinner</h2>

            <Ovelshapedloadingspinner />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>Animated loading dots</h2>

            <Animatedloadingdots />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
            <Throbbingloadinganimation />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>Loding spinner with image inside</h2>

            <Lodingspinnerwithimageinside />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
            
            <Loadinganimationusinganimateping />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>Dashedspinners</h2>

            <Dashedspinners />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>Spinner intailwind</h2>

            <Spinnerintailwind />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">

            <LoaderDesignspinning />
          </div>
          <div className="w-[100%] border border-[blue] h-[200px] flex justify-center items-center">
          <h2>animate-spin spinner</h2>
...
function Loadinganimationusinganimateping() {
  return (
    <>
      <h2>Loading animation using animate-ping</h2>
      <div className="flex justify-center items-center h-screen">
